...
public interface PaymentRequestUseCases {
	...
	void importPayemntsRequests(InputStream stream, PaymentImportHandler handler, PaymentImporter paymentImporter)
			throws ParseException;

	String generatePaymentImportReport(PaymentImportHandler handler);
